          ...
          <div className="bg-white border border-[#e8e8e8] lg:border-[#ddd]" style={{ boxShadow: "0 2px 12px rgba(0,0,0,0.04)" }}>
            ...
            <AnimatePresence mode="wait">
              ...
              {!submitted && step === 1 && (
                ...
                >
                  <p
                    className="text-[15px] lg:text-[18px] font-bold uppercase tracking-[0.06em] text-[#1c1d1f] mb-3 lg:mb-4"
                    style={RIFT}
                  >
              ...
              {!submitted && step === 2 && (
                ...
                >
                  <div className="flex items-center gap-1.5 mb-3 lg:mb-4">
                    ...
                    <p
                      className="text-[15px] lg:text-[18px] font-bold uppercase tracking-[0.06em] text-[#1c1d1f]"
                      style={RIFT}
                    >
